...
func (self *Apu) CpuWrite(addr uint16, data uint8) {
	...
	case 0x4000:
		...
		switch (data & 0xC0) >> 6 {
		case 0x00:
			self.sequencers[ch].new_sequence = 0b01000000
			self.oscpulses[ch].dutycycle = 0.125
		case 0x01:
			self.sequencers[ch].new_sequence = 0b01100000
			self.oscpulses[ch].dutycycle = 0.250
		case 0x02:
			self.sequencers[ch].new_sequence = 0b01111000
			self.oscpulses[ch].dutycycle = 0.500
		case 0x03:
			self.sequencers[ch].new_sequence = 0b10011111
			self.oscpulses[ch].dutycycle = 0.750
		}
	...
	case 0x400E:
		...
		switch data & 0x0F {
		case 0x00:
			self.sequencers[ch].reload = 0
		case 0x01:
			self.sequencers[ch].reload = 4
		case 0x02:
			self.sequencers[ch].reload = 8
		case 0x03:
			self.sequencers[ch].reload = 16
		case 0x04:
			self.sequencers[ch].reload = 32
		case 0x05:
			self.sequencers[ch].reload = 64
		case 0x06:
			self.sequencers[ch].reload = 96
		case 0x07:
			self.sequencers[ch].reload = 128
		case 0x08:
			self.sequencers[ch].reload = 160
		case 0x09:
			self.sequencers[ch].reload = 202
		case 0x0A:
			self.sequencers[ch].reload = 254
		case 0x0B:
			self.sequencers[ch].reload = 380
		case 0x0C:
			self.sequencers[ch].reload = 508
		case 0x0D:
			self.sequencers[ch].reload = 1016
		case 0x0E:
			self.sequencers[ch].reload = 2034
		case 0x0F:
			self.sequencers[ch].reload = 4068
		}
	case 0x400F:
		// uncomments p1/p2 at 2024.02.20
